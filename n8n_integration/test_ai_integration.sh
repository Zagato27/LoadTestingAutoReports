...
print_summary() {
    ...
    if [ $TESTS_FAILED -eq 0 ]; then
        ...
        echo ""
        info "Рекомендации:"
        echo "  1. Проверьте логи: docker-compose -f docker-compose.n8n.yml logs"
        echo "  2. Убедитесь, что все сервисы запущены: docker-compose -f docker-compose.n8n.yml ps"
